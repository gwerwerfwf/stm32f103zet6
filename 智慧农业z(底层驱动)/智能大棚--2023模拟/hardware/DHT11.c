...
/**********************************************
函数名：uint8_t DHT11_Init(void)
参数说明：无
返回值：uint8_t ,返回1代表初始化成功，0则失败
函数作用：配置IO口，并发送开始信号
***********************************************/
...
/**********************************************
函数名：static uint8_t DHT11_Check(void)
参数说明：无
返回值：检测到回应-->返回1，否则0
函数作用：检测DHT11的响应信号
***********************************************/
...
/**********************************************
函数名：static uint8_t DHT11_Read_Bit(void)
参数说明：无
...
/***********************************************************************
函数名：static uint8_t DHT11_Read_Byte(void)
参数说明：无
...
/**************************************************************************
函数名：uint8_t DHT11_Read_Data(uint8_t *temp,uint8_t *humi)
